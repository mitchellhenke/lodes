...
# aws s3api put-object --bucket lodes-public --key "tiles/year=2023/geography=tract/tiles-2023-tract.pmtiles" --body  "output/tiles/year=2023/geography=tract/tiles-2023-tract.pmtiles" --checksum-algorithm CRC32 --endpoint-url "https://f8de4764a973ce6156967ec64aab41f3.r2.cloudflarestorage.com/"
